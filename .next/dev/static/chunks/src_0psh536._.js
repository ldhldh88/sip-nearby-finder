...
function DistrictAssigner({ place }) {
    ...
    const handleSave = async ()=>{
        ...
        setIsSaving(true);
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].functions.invoke("add-place-to-cache", {
                body: {
...
//# sourceMappingURL=src_0psh536._.js.map