...
"[project]/src/app/api/cached-places/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    const districtId = String(body.district_id ?? "");
    const kakaoPlaceId = String(body.kakao_place_id ?? "");
    const placeData = body.place_data;
    ...
    const district = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].district.findUnique({
        where: {
            id: districtId
        },
        select: {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].cachedPlace.upsert({
        where: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0k0w2n_._.js.map