...
"[project]/src/app/api/district-bars/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    const rows = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$queryRaw`SELECT * FROM public.get_district_bars(${districtName});`;
    const places = [];
    const metaMap = {};
    for (const row of rows){
        places.push(row.place_data);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__008n5je._.js.map